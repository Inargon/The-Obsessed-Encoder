...
watermarked PushT setting.  At the end of the full seed-zero run, hard
...
hard admission may act as an aggressive encoder-side prediction bottleneck.

\subsection{Magnitude versus direction}

In matched 10k screening runs, norm-matched scalar attenuation reaches success
$0.42$, hard routing $0.36$, and a retention-matched shuffled guide $0.28$.
...
opposite failure boundary: hard routing can suppress predictive learning that
...
for LeWM, $0.70$ for hard routing, and $0.82$ for both control-only and
