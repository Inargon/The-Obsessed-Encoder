#!/usr/bin/env python3
"""Evaluate one frozen Reacher checkpoint with the training-time protocol."""
...
def main() -> None:
    ...
    parser.add_argument("--checkpoint", default="weights_step_5000.pt")
    parser.add_argument("--dataset", default="dmc/reacher_random.h5")
