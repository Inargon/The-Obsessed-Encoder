...
def lejepa_forward(self, batch, stage, cfg):
    ...
    if hasattr(self.model, "control_objective"):
        ...
        # Optional asymmetric gradient surgery. The prediction loss continues
        # to train the predictor in full, while only its representation-level
        # component that opposes the protected control gradient is removed.
        route_cfg = cfg.loss.get("gradient_routing")
    ...
    metrics_dict = {
        ...
        if "loss" in k or k in {
            ...
            "prediction_control_conflict_fraction",
